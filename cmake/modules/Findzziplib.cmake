...
FIND_LIBRARY(ZZIPLIB_LIBRARY_DEBUG NAMES zzipd zziplibd)
FIND_LIBRARY(ZZIPLIB_LIBRARY_RELEASE NAMES zzip zziplib)

# Handle the QUIETLY and REQUIRED arguments and set ZZIPLIB_FOUND to TRUE if all listed variables are TRUE.
INCLUDE(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(ZZIPLIB DEFAULT_MSG ZZIPLIB_LIBRARY_DEBUG ZZIPLIB_LIBRARY_RELEASE ZZIPLIB_INCLUDE_DIR)

# Copy the results to the output variables.
IF(ZZIPLIB_FOUND)
	SET(ZZIPLIB_LIBRARIES debug ${ZZIPLIB_LIBRARY_DEBUG} optimized ${ZZIPLIB_LIBRARY_RELEASE})
