#ifndef H__PLAT_PANDORA__H
#define H__PLAT_PANDORA__H

#include "plat/plat_sdl.h"

class GW_PlatformPandora : public GW_PlatformSDL
{
public:
    GW_PlatformPandora() : GW_PlatformSDL(800, 480, true, true) {}
